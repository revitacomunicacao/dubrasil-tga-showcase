...
const VideoCarousel = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-16">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-30 w-12 h-12 bg-primary-foreground/10 hover:bg-primary-foreground/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-all group"
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 right-8 z-30 hidden md:flex flex-col items-center gap-2 text-primary-foreground/60">
